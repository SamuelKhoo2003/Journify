...
const MoodGrid: React.FC = () => {
  ...
  return (
    <div className="bg-stone-200 p-4 text-white flex-row ml-2 mr-2 rounded-lg">
      <div className="text-sm mb-2" style={{ color: '#A98876' }}>{countSentimentsForThisYear()} journal entries to date</div>
